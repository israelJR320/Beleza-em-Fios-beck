...
module.exports = { 
    ...
    generateAiArticles, 
    askAiQuestion,
    comparePhotos // Inclui a nova função
};

// Atualize o módulo de exportação para incluir a nova função
module.exports = { generateAiRoutine, generateAiTip, generateAiArticles, askAiQuestion };